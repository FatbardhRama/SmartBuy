...
export default async function DealsPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-6 pb-20 pt-10 sm:pb-24 sm:pt-12">
      <section className="relative mb-10 overflow-hidden rounded-[2rem] bg-[linear-gradient(118deg,#0B1224_0%,#132D72_58%,#087A98_125%)] px-6 py-10 text-white shadow-[0_28px_76px_-42px_rgba(15,23,42,0.9)] sm:px-10 sm:py-14">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
          <div className="max-w-2xl">
            <p className="flex items-center gap-2 text-sm font-semibold text-cyan-300"><BadgePercent className="size-4" aria-hidden="true" /> SmartBuy deals</p>
            <h1 className="mt-4 max-w-xl text-4xl font-bold tracking-[-0.04em] sm:text-5xl">Well-priced tech, ready when you are.</h1>
            <p className="mt-4 max-w-xl text-base leading-7 text-slate-300">A live selection of in-stock devices and accessories from approved SmartBuy marketplace sellers.</p>
          </div>
      ...
      <div className="mb-7 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div><p className="text-sm font-semibold text-primary">Current offers</p><h2 className="mt-1 text-2xl font-bold tracking-[-0.03em] sm:text-3xl">Explore the latest deals</h2></div>
      ...
      {products.length > 0 ? (
        ...
        <div className="rounded-2xl border border-dashed border-primary/20 bg-card px-6 py-16 text-center shadow-[0_20px_50px_-40px_rgba(15,23,42,0.35)]">
